...
export class PopulationCouvrirComponent implements OnInit {
  ...
  constructor(private currentModalRef: MatDialogRef<any>,private dialog: MatDialog,private fb: FormBuilder,private router: Router,private http: HttpClient,private sharedData:SharePopulationDataComponent){
